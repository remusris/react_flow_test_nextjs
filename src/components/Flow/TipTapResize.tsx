...
const TipTapResize = (props: NodeProps) => {
  ...
  return (
    <>
      <NodeResizeControl position="bottom-left" minWidth={100} minHeight={100}>
        <Scaling></Scaling>
      </NodeResizeControl>
      <div className="border border-2 border-blue-500">
...
export default memo(TipTapResize);
